...
<div class="row justify-content-center my-4">
  <div class="col-md-10 col-lg-8">
    <img src="../../assets/img/undraw_online-organizer_1kdy.png" alt="Ilustrație: organizare digitală a sarcinilor și fluxurilor de lucru într-un cabinet juridic" class="img-fluid" loading="lazy" decoding="async" />
  </div>
</div>
...
<div class="row justify-content-center my-4">
  <div class="col-md-10 col-lg-8">
    <img src="../../assets/img/undraw_events_0w4f.png" alt="Ilustrație: calendar digital și urmărirea termenelor pentru dosare și întâlniri" class="img-fluid" loading="lazy" decoding="async" />
  </div>
</div>
