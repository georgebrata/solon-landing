...
description: "Ghid practic Gmail pentru avocați: cum folosești filtre, etichete, șabloane, aliasuri, delegare, căutare avansată și automatizări."
read_time: 6
categories: ["automatizări", "digitalizare", "productivitate"]
tags: ["gmail", "avocați", "productivitate", "automatizări", "comunicare"]
---
...
<div class="row justify-content-center my-4">
  <div class="col-md-9">
    <img src="../../assets/img/undraw_inbox-cleanup_be27.png" alt="Ilustrație: organizarea inbox-ului Gmail pentru activitatea juridică" class="img-fluid rounded shadow-sm" loading="lazy" decoding="async" />
  </div>
</div>
...
<div class="row justify-content-center my-4">
  <div class="col-md-9">
    <img src="../../assets/img/undraw_mobile-inbox_aszm.png" alt="Ilustrație: utilizarea Gmail pe mobil pentru avocați în deplasare" class="img-fluid rounded shadow-sm" loading="lazy" decoding="async" />
  </div>
</div>
