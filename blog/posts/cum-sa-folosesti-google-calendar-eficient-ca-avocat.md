...
<div class="row justify-content-center my-4">
  <div class="col-md-8">
    <img src="../../assets/img/undraw-calendar.png" alt="Ilustrație: organizare în calendar digital pentru avocați" class="img-fluid" loading="lazy" decoding="async" />
  </div>
</div>
...
<div class="row justify-content-center my-4">
  <div class="col-lg-10">
    <img src="../../assets/img/find-a-time.png" alt="Google Calendar Find a time pentru identificarea intervalelor comune" class="img-fluid rounded shadow-sm" loading="lazy" decoding="async" />
  </div>
</div>
...
<div class="row justify-content-center my-4">
  <div class="col-md-8">
    <img src="../../assets/img/undraw_Schedule_re_2vro.png" alt="Ilustrație: planificarea întâlnirilor în calendar" class="img-fluid" loading="lazy" decoding="async" />
  </div>
</div>
