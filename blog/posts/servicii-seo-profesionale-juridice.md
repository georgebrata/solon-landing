...
<div class="row justify-content-center my-4">
  <div class="col-8">
    <img src="../../assets/img/undraw_search-engines_k649.png" alt="Ilustrație SEO: căutare online și analiză rezultate pentru servicii juridice" class="img-fluid" loading="lazy" decoding="async" />
  </div>
</div>
...
1. problema clientului formulată clar, în limbaj simplu;
2. tipurile de situații pe care le gestionezi;
3. pașii colaborării (consultație, analiză, strategie, implementare);
4. estimări realiste privind timp, documente și costuri;
5. întrebări frecvente și obiecții comune.
...
<div class="row justify-content-center my-4">
  <div class="col-8">
    <img src="../../assets/img/undraw_web-search_7oif.png" alt="Ilustrație SEO: analiză rezultate web pentru creșterea vizibilității unui cabinet de avocatură" class="img-fluid" loading="lazy" decoding="async" />
  </div>
</div>
...
1. "Generează 20 de întrebări frecvente pentru clienți care caută avocat în litigii de muncă, orientate pe intenție informațională și comercială."
2. "Propune structura unei pagini SEO pentru serviciul de consultanță juridică IMM, cu secțiuni orientate pe conversie."
3. "Rescrie textul într-un ton profesionist, clar și empatic, evitând jargonul excesiv."
