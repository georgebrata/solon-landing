...
<div class="row justify-content-center my-4">
  <div class="col-md-9">
    <img src="../../assets/img/undraw_artificial-intelligence_43qa.png" alt="Ilustrație: inteligență artificială și sinteză de informații pentru activitate juridică" class="img-fluid rounded shadow-sm" loading="lazy" decoding="async" />
  </div>
</div>
...
<div class="row justify-content-center my-4">
  <div class="col-md-9">
    <img src="../../assets/img/undraw_mcp-server_7kvc.png" alt="Ilustrație: surse multiple și nucleu central de cunoaștere - organizarea documentelor în NotebookLM" class="img-fluid rounded shadow-sm" loading="lazy" decoding="async" />
  </div>
</div>
